...
def example_simple_rvo():
    ...
    for step in range(simulation_steps):
        ...
        for a in range(agents_count):
            ...
            # compute move vector
            to_vector: Tuple[float, float] = (target[0] - pos[0], target[1] - pos[1])
            ...
            if to_length > 1.0:
                to_vector = (to_vector[0] / to_length, to_vector[1] / to_length)
...
def example_pathfinder():
    ...
    vertices = [(-4.0, 0.0, -4.0), (4.0, 0.0, -4.0), (4.0, 0.0, 4.0), (-4.0, 0.0, 4.0)]
    polygons = [[0, 1, 2, 3]]
